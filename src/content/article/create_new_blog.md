...
### md ファイル内の public 配下にある画像取得が遅すぎる

md ファイルだと public 配下にあるものでないと画像の取得が出来ないのだが、なんせその画像の読み込みが 3 秒くらいかかって遅い
ローカルにある画像なのにこんな遅いのかという気持ちである

MDX だと src 配下のものが使えて`astro/image`ライブラリが使えたりするのだが、md ファイルだと使えない
